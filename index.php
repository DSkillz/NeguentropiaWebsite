...
<head itemscope="" itemtype="http://schema.org/WebSite">
    ...
    <link rel="alternate" type="application/rss+xml"
        title="Neguentropia Research Institute for Environmental Sciences » Flux" href="https://neguentropia.org/feed">
    <link rel="alternate" type="application/rss+xml"
        title="Neguentropia Research Institute for Environmental Sciences » Flux des commentaires"
        href="https://neguentropia.org/comments/feed">

    <!-- CSS -->
    <link rel="stylesheet" id="blossom-coach-css" href="css/wp_content/blossom_coach_theme/main.css" type="text/css"
        media="all">
...
<body
    class="home page-template-default page page-id-472 custom-background wp-custom-logo custom-background-image custom-background-color style1 underline full-width centered"
    itemscope="" itemtype="http://schema.org/WebPage" cz-shortcut-listen="true">

    <div id="page" class="site"><a aria-label="Accéder au contenu" class="skip-link screen-reader-text"
            href="#acc-content">Aller au contenu</a>

        <header id="masthead" class="site-header" itemscope="" itemtype="http://schema.org/WPHeader">
            <div class="header-t">
                <div class="wrapper" style="display: flex; justify-content: space-between; align-items: center;">
                    <div class="top-left" style="display: flex;"><span style="display: flex; align-items: center;"><svg
                                class="svg-inline--fa fa-phone" aria-hidden="true" focusable="false" data-prefix="fas"
                                ...
                                href="tel:+33659281822"><span class="phone">+33659281822</span></a></span><span><svg
                    ...
                    <div class="top-right">
                        <div class="header-social">
                            <ul class="social-icons">
                                ...
                                <li><a href="https://www.youtube.com/@Neguentropia" target="_blank" rel="nofollow"><svg
                                ...
                                <li><a href="https://www.instagram.com/neguentropiaresearch/" target="_blank"
                                        rel="nofollow"><svg class="svg-inline--fa fa-instagram" aria-hidden="true"
  ...
  border-radius: 7px;" target="_blank" rel="nofollow"><svg
                                        ...
                                        </svg><!-- <i class="fab fa-gratipay"></i> Font Awesome fontawesome.com --><span
                                            id="donText" style="color: red;">Soutenir</span></button></li>
                            </ul>
                        </div>
                        <!-- .header-social -->
                        <div class="header-search"> <button aria-label="Basculer vers le formulaire de recherche"
                            ...
                            <div class="header-search-form search-modal cover-modal"
                                data-modal-target-string=".search-modal">
                                <div class="header-search-inner-wrap">
                                    <form role="search" method="get" class="search-form" action="/">
                                        <label class="screen-reader-text">Vous recherchiez quelque
                                            chose ?</label> <input class="search-field"
                                            placeholder="Saisissez des mots-clés…" value="" name="s" type="search">
                                        <label for="submit-field">
                                            <span><svg class="svg-inline--fa fa-magnifying-glass" aria-hidden="true"
                                            ...
                                            <input id="submit-field" class="search-submit" value="Rechercher"
                                                type="submit"> </label>
                                    </form>
                                    <button aria-label="Fermer le formulaire de recherche" class="close"
                                        data-toggle-target=".search-modal" data-toggle-body-class="showing-search-modal"
                                        data-set-focus=".search-modal .search-field" aria-expanded="false"></button>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="main-header">
                <div class="wrapper">
                    <div class="site-branding icon-text" itemscope="" itemtype="http://schema.org/Organization">
                        <div class="site-logo"><a href="/" class="custom-logo-link" rel="home" aria-current="page"><img
                                    src="img/uploads/2023/07/cropped-channels4_profile-1.jpg" class="custom-logo"
                                    alt="logo neguentropia" decoding="async" fetchpriority="high"
                                    srcset="img/uploads/2023/07/cropped-channels4_profile-1.jpg 600w, img/uploads/2023/07/cropped-channels4_profile-1-300x300.jpg 300w, img/uploads/2023/07/cropped-channels4_profile-1-150x150.jpg 150w, img/uploads/2023/07/cropped-channels4_profile-1-60x60.jpg 60w"
                                    sizes="(max-width: 600px) 100vw, 600px" height="600" width="600"></a></div>
                        <!-- .site-logo -->
                        ...
                        <nav id="site-navigation" class="main-navigation" itemscope=""
                            ...
                            <div class="primary-menu-list main-menu-modal cover-modal"
                                ...
                                <button class="close close-main-nav-toggle" data-toggle-target=".main-menu-modal"
                                    data-toggle-body-class="showing-main-menu-modal" aria-expanded="false"
                                    data-set-focus=".main-menu-modal"
                                    aria-label="Mobile Navigation"><span></span></button>
                                <div class="mobile-menu" aria-label="Mobile">
                                    <div class="menu-primaire-container">
                                        <ul id="primary-menu" class="menu main-menu-modal">
                                            <li id="menu-item-473"
                                                class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home current-menu-item page_item page-item-472 current_page_item menu-item-473">
                                            ...
                                            <li id="menu-item-45"
                                                ...
                                                <button onclick="linkclick('ecology_guide.php')">Petit Précis
                                                    d'Écologie</button>
                                            </li>
                                            <li id="menu-item-53"
                                            ...
                                            <li id="menu-item-470"
                                                class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-470">
                                                <a href="" aria-current="disable-link">Consulting</a><button
                                                    class="submenu-toggle"><svg class="svg-inline--fa fa-angle-down"
                                                ...
                                                <ul class="sub-menu">
                                                    <li id="menu-item-643"
                                                        ...
                                                        <a href="#"
                                                            onclick="linkclick('strategie_climatbiodivenergie.php')">Stratégie
                                            ...
                                            <li id="menu-item-54"
                                                ...
                                                <a href="" aria-current="disable-link">Sensibilisation</a><button
                                                    class=" submenu-toggle"><svg class="svg-inline--fa fa-angle-down"
                                                        aria-hidden="true" focusable="false" data-prefix="fas"
                                                        data-icon="angle-down" role="img"
                                                        xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"
                                                ...
                                                <ul class="sub-menu">
                                                    ...
                                                    <li id="menu-item-500"
                                                        ...
                                                        <a
                                                            href="https://neguentropia.org/la-fresque-de-la-biodiversite">La
                                            ...
                                            <li style="position:relative;" class="menu-item menu-item-gtranslate">
                                                <div style="position:absolute;white-space:nowrap;"
                                                    id="gtranslate_menu_wrapper_17622" class="gt_container-93ts0l">
        ...
        <script src="js/gtranslate/float.js" data-no-optimize="1" data-no-minify="1" data-gt-orig-url="/"
            data-gt-orig-domain="neguentropia.org" data-gt-widget-id="86148270" defer="defer"></script>
